...
class Camera{
    ...
    void draw(Program* prog){
		draw(prog, "projMatrix", "viewMatrix", "eyePos");
    }
    
	void draw(Program* prog, string projName, string viewName,  string eyeName) {
		prog->setUniform(projName, this->projmatrix);
		prog->setUniform(viewName, this->viewmatrix);
		prog->setUniform(eyeName, this->eye.xyz());
	}
    void turn(float  a){
